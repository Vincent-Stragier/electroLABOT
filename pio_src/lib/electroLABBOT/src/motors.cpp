...
void motors_task(void *parameter) {
  ...
  for (;;) {
    ...
    left_motor_acceleration = (left_motor_acceleration / 1000) * refresh_ms;
    ...
    right_motor_acceleration = (right_motor_acceleration / 1000) * refresh_ms;
...
void Motors::left_motor_speed(int16_t left_motor_speed, uint16_t acceleration) {
  ...
  xQueueOverwrite(xQueue_left_motor_speed, &_left_motor_speed);
}
...
void Motors::right_motor_speed(int16_t right_motor_speed,
  ...
  xQueueOverwrite(xQueue_right_motor_speed, &_right_motor_speed);
}
